...
.LBB8:
	...
	movq	%rax, %rdi
	call	lua_pcallk@PLT
	.loc 2 156 11 discriminator 2
	testl	%eax, %eax
	je	.L30
.L29:
	.loc 2 156 11 is_stmt 0 discriminator 3
	movl	$1, %eax
	jmp	.L31
.L30:
	.loc 2 156 11 discriminator 4
	movl	$0, %eax
.L31:
	.loc 2 156 8 is_stmt 1 discriminator 6
	movl	%eax, -104(%rbp)
	.loc 2 159 7 discriminator 6
	cmpl	$0, -104(%rbp)
	jne	.L32
.LBB9:
	.loc 2 161 29
...
.L39:
	...
	cmpl	$0, -100(%rbp)
	jne	.L38
	.loc 2 221 30 discriminator 1
	movq	-120(%rbp), %rax
	movq	56(%rax), %rdx
	.loc 2 221 39 discriminator 1
	movl	-108(%rbp), %eax
	cltq
	salq	$3, %rax
	addq	%rdx, %rax
	movq	(%rax), %rax
	.loc 2 221 25 discriminator 1
	testq	%rax, %rax
	je	.L38
	.loc 2 222 8
	cmpq	$0, -64(%rbp)
	...
	call	ms_queue_put
.L38:
	.loc 2 218 39 discriminator 2
	addl	$1, -108(%rbp)
.L37:
	.loc 2 218 20 discriminator 1
	movq	-120(%rbp), %rax
	movq	(%rax), %rax
	.loc 2 218 26 discriminator 1
	movl	44(%rax), %eax
	.loc 2 218 17 discriminator 1
	cmpl	%eax, -108(%rbp)
	jl	.L39
	.loc 2 226 2
	movq	-80(%rbp), %rax
