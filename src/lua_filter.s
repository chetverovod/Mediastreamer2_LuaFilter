...
.LBE9:
	...
	movq	%rax, %rdi
	call	lua_pcallk@PLT
	.loc 2 158 11 discriminator 2
	testl	%eax, %eax
	je	.L30
.L29:
	.loc 2 158 11 is_stmt 0 discriminator 3
	movl	$1, %eax
	jmp	.L31
.L30:
	.loc 2 158 11 discriminator 4
	movl	$0, %eax
.L31:
	.loc 2 158 8 is_stmt 1 discriminator 6
	movl	%eax, -96(%rbp)
	.loc 2 161 7 discriminator 6
	cmpl	$0, -96(%rbp)
	jne	.L32
.LBB10:
	.loc 2 163 29
...
.L40:
	...
	testq	%rax, %rax
	je	.L39
	.loc 2 221 56 discriminator 2
	movq	-48(%rbp), %rax
	movzbl	24(%rax), %eax
	.loc 2 221 51 discriminator 2
	testb	%al, %al
	jne	.L39
	.loc 2 222 8
	cmpq	$0, -56(%rbp)
	...
	call	ms_queue_put
.L39:
	.loc 2 219 39 discriminator 2
	addl	$1, -100(%rbp)
.L38:
	.loc 2 219 20 discriminator 1
	movq	-120(%rbp), %rax
	movq	(%rax), %rax
	.loc 2 219 26 discriminator 1
	movl	44(%rax), %eax
	.loc 2 219 17 discriminator 1
	cmpl	%eax, -100(%rbp)
	jl	.L40
.L37:
	.loc 2 226 2
