...
# 23 "/usr/include/mediastreamer2/msfilter.h" 3 4
...
# 24 "/usr/include/mediastreamer2/msfilter.h" 2 3 4
...
{
  lua_State* L;
  char *script_preamble;

  char *script_code;

  bool_t stopped;
  bool_t preabmle_was_run;
  char padding[6];
} ControlData;
...
# 114 "lua_filter.c" 3 4
ortp_free
# 114 "lua_filter.c"
      (cd->script_code);

# 115 "lua_filter.c" 3 4
ortp_free
# 115 "lua_filter.c"
      (cd->script_preamble);

# 116 "lua_filter.c" 3 4
ortp_free
# 116 "lua_filter.c"
      (cd);
}
...
# 158 "lua_filter.c"
   ...
   if (!err)
   {
    int script_body_status = 
# 163 "lua_filter.c" 3 4
                            lua_tointegerx(
# 163 "lua_filter.c"
                            d->L
# 163 "lua_filter.c" 3 4
...
# 181 "lua_filter.c"
    ...
    size_t msg_len = 0;
    if (lua_type(d->L, lua_gettop(d->L)) == 
# 187 "lua_filter.c" 3 4
                                           4
# 187 "lua_filter.c"
                                                      )
    {
...
# 245 "lua_filter.c" 3 4
 ortp_free
# 245 "lua_filter.c"
        (d->script_code);
 d->script_code = 
# 246 "lua_filter.c" 3 4
                 ortp_strdup
# 246 "lua_filter.c"
                          (*(char **)arg);
 
# 247 "lua_filter.c" 3 4
ortp_free
# 247 "lua_filter.c"
       (*(char **)arg);
 }
...
# 263 "lua_filter.c" 3 4
 ortp_free
# 263 "lua_filter.c"
        (d->script_code);
 d->script_code = 
# 264 "lua_filter.c" 3 4
                 ortp_strdup
# 264 "lua_filter.c"
                          (*(char **)arg);
 
# 265 "lua_filter.c" 3 4
ortp_free
# 265 "lua_filter.c"
       (*(char **)arg);
 }
...
# 280 "lua_filter.c" 3 4
 ortp_free
# 280 "lua_filter.c"
        (d->script_preamble);
 d->script_preamble = 
# 281 "lua_filter.c" 3 4
                     ortp_strdup
# 281 "lua_filter.c"
                              (*(char **)arg);
