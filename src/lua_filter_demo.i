# 0 "lua_filter_demo.c"
# 1 "/home/primauser/plastov/Mediastreamer2_LuaFilter/src//"
# 0 "<built-in>"
# 0 "<command-line>"
...
# 3 "lua_filter_demo.c" 2


# 1 "/usr/include/mediastreamer2/mssndcard.h" 1 3 4
# 23 "/usr/include/mediastreamer2/mssndcard.h" 3 4
# 1 "/usr/include/mediastreamer2/mscommon.h" 1 3 4
# 22 "/usr/include/mediastreamer2/mscommon.h" 3 4
# 1 "/usr/include/bctoolbox/port.h" 1 3 4
# 30 "/usr/include/bctoolbox/port.h" 3 4
...
# 31 "/usr/include/bctoolbox/port.h" 2 3 4
...
# 32 "/usr/include/bctoolbox/port.h" 2 3 4
...
# 33 "/usr/include/bctoolbox/port.h" 2 3 4
...
# 34 "/usr/include/bctoolbox/port.h" 2 3 4
...
# 35 "/usr/include/bctoolbox/port.h" 2 3 4
...
# 36 "/usr/include/bctoolbox/port.h" 2 3 4
...
# 37 "/usr/include/bctoolbox/port.h" 2 3 4
# 1 "/usr/lib/gcc/x86_64-linux-gnu/11/include/stdarg.h" 1 3 4
# 38 "/usr/include/bctoolbox/port.h" 2 3 4
...
# 39 "/usr/include/bctoolbox/port.h" 2 3 4
...
# 40 "/usr/include/bctoolbox/port.h" 2 3 4
...
# 43 "/usr/include/bctoolbox/port.h" 2 3 4
...
# 48 "/usr/include/bctoolbox/port.h" 2 3 4
...
# 49 "/usr/include/bctoolbox/port.h" 2 3 4
...
# 51 "/usr/include/bctoolbox/port.h" 2 3 4
...
# 54 "/usr/include/bctoolbox/port.h" 2 3 4
...
# 55 "/usr/include/bctoolbox/port.h" 2 3 4
...
# 93 "/usr/include/bctoolbox/port.h" 3 4
...
# 336 "/usr/include/bctoolbox/port.h" 3 4
typedef unsigned char bool_t;
# 350 "/usr/include/bctoolbox/port.h" 3 4
...
void bctbx_set_memory_functions(BctoolboxMemoryFunctions *functions);
 ...
 char *bctbx_strdup_printf(const char *fmt,...) __attribute__ ((format (printf, 1, 2)));
 char *bctbx_strdup_vprintf(const char *fmt, va_list ap);
 char *bctbx_strcat_printf(char *dst, const char *fmt,...) __attribute__ ((format (printf, 2, 3)));
...
# 406 "/usr/include/bctoolbox/port.h" 3 4
 char *bctbx_dirname(const char *path);
# 421 "/usr/include/bctoolbox/port.h" 3 4
...
# 460 "/usr/include/bctoolbox/port.h" 3 4
...
# 481 "/usr/include/bctoolbox/port.h" 3 4
 ...
 int bctbx_getnameinfo(const struct sockaddr *address, socklen_t address_len, char *host, socklen_t hostlen, char *serv, socklen_t servlen, int flags);
 ...
 struct addrinfo *bctbx_addrinfo_sort(struct addrinfo *ai);
# 516 "/usr/include/bctoolbox/port.h" 3 4
 struct addrinfo * bctbx_ip_address_to_addrinfo(int family, int socktype, const char *ipaddress, int port);
...
# 566 "/usr/include/bctoolbox/port.h" 3 4
...
typedef int bctbx_pipe_t;
 ...
 int bctbx_server_pipe_close_client(bctbx_pipe_t client);
 ...
 void bctbx_shm_close(void *memory);

 bool_t bctbx_is_multicast_addr(const struct sockaddr *addr);
# 610 "/usr/include/bctoolbox/port.h" 3 4
...
# 654 "/usr/include/bctoolbox/port.h" 3 4
...
# 671 "/usr/include/bctoolbox/port.h" 3 4
 uint64_t bctbx_str_to_uint64(const uint8_t input_string[17]);
# 23 "/usr/include/mediastreamer2/mscommon.h" 2 3 4
# 1 "/usr/include/bctoolbox/list.h" 1 3 4
# 23 "/usr/include/bctoolbox/list.h" 3 4
# 1 "/usr/include/bctoolbox/port.h" 1 3 4
# 24 "/usr/include/bctoolbox/list.h" 2 3 4
...
typedef void* (*bctbx_list_copy_func)(void *);
 ...
 bctbx_list_t * bctbx_list_find_custom(const bctbx_list_t * list, bctbx_compare_func cmp, const void *user_data);
 ...
 bctbx_list_t * bctbx_list_insert_sorted(bctbx_list_t * list, void *data, bctbx_compare_func cmp);
...
# 24 "/usr/include/mediastreamer2/mscommon.h" 2 3 4
# 1 "/usr/include/bctoolbox/logging.h" 1 3 4
# 29 "/usr/include/bctoolbox/logging.h" 3 4
# 1 "/usr/include/bctoolbox/port.h" 1 3 4
# 30 "/usr/include/bctoolbox/logging.h" 2 3 4
# 50 "/usr/include/bctoolbox/logging.h" 3 4
typedef enum {
 BCTBX_LOG_DEBUG=1,
 BCTBX_LOG_TRACE=1<<1,
...
# 91 "/usr/include/bctoolbox/logging.h" 3 4
 bctbx_log_handler_t* bctbx_create_log_handler(BctbxLogHandlerFunc func, BctbxLogHandlerDestroyFunc destroy, void* user_data);
# 101 "/usr/include/bctoolbox/logging.h" 3 4
 ...
 void bctbx_log_handler_set_user_data(bctbx_log_handler_t*, void* user_data);
 ...
 void bctbx_logv_out(const char *domain, BctbxLogLevel level, const char *fmt, va_list args);
 void bctbx_logv_file(void* user_info, const char *domain, BctbxLogLevel level, const char *fmt, va_list args);
...
# 208 "/usr/include/bctoolbox/logging.h" 3 4
static inline void bctbx_log(const char* domain, BctbxLogLevel lev, const char *fmt,...) {
 va_list args;
...
static inline void __attribute__((format(printf,1,2))) bctbx_message(const char *fmt,...)
{
 va_list args;
 __builtin_va_start(args,fmt);
 bctbx_logv("bctbx", BCTBX_LOG_MESSAGE, fmt, args);
 __builtin_va_end(args);
}

static inline void __attribute__((format(printf,1,2))) bctbx_warning(const char *fmt,...)
{
 va_list args;
 __builtin_va_start(args,fmt);
 bctbx_logv("bctbx", BCTBX_LOG_WARNING, fmt, args);
 __builtin_va_end(args);
}



static inline void __attribute__((format(printf,1,2))) bctbx_error(const char *fmt,...)
{
 va_list args;
 __builtin_va_start(args,fmt);
 bctbx_logv("bctbx", BCTBX_LOG_ERROR, fmt, args);
 __builtin_va_end(args);
}

static inline void __attribute__((format(printf,1,2))) bctbx_fatal(const char *fmt,...)
{
 va_list args;
 __builtin_va_start(args,fmt);
 bctbx_logv("bctbx", BCTBX_LOG_FATAL, fmt, args);
 __builtin_va_end(args);
}
# 25 "/usr/include/mediastreamer2/mscommon.h" 2 3 4
# 1 "/usr/include/ortp/port.h" 1 3 4
# 61 "/usr/include/ortp/port.h" 3 4
...
# 87 "/usr/include/ortp/port.h" 3 4
...
# 290 "/usr/include/ortp/port.h" 3 4
...
# 26 "/usr/include/mediastreamer2/mscommon.h" 2 3 4
# 1 "/usr/include/ortp/str_utils.h" 1 3 4
# 41 "/usr/include/ortp/str_utils.h" 3 4
...
# 161 "/usr/include/ortp/str_utils.h" 3 4
...
# 27 "/usr/include/mediastreamer2/mscommon.h" 2 3 4
# 1 "/usr/include/ortp/payloadtype.h" 1 3 4
# 65 "/usr/include/ortp/payloadtype.h" 3 4
struct _PayloadTypeAvpfParams {
 unsigned char features;
 bool_t rpsi_compatibility;
...
extern PayloadType payload_type_l16_mono;
extern PayloadType payload_type_l16_stereo;
...
extern PayloadType payload_type_cn;
...
extern PayloadType payload_type_aal2_g726_40;
extern PayloadType payload_type_aal2_g726_32;
extern PayloadType payload_type_aal2_g726_24;
extern PayloadType payload_type_aal2_g726_16;
extern PayloadType payload_type_gsm;
extern PayloadType payload_type_lpc;
extern PayloadType payload_type_lpc1015;
extern PayloadType payload_type_speex_nb;
extern PayloadType payload_type_speex_wb;
extern PayloadType payload_type_speex_uwb;
...
extern PayloadType payload_type_evrc0;
extern PayloadType payload_type_evrcb0;
extern PayloadType payload_type_silk_nb;
extern PayloadType payload_type_silk_mb;
extern PayloadType payload_type_silk_wb;
extern PayloadType payload_type_silk_swb;
extern PayloadType payload_type_aaceld_16k;
extern PayloadType payload_type_aaceld_22k;
extern PayloadType payload_type_aaceld_32k;
extern PayloadType payload_type_aaceld_44k;
extern PayloadType payload_type_aaceld_48k;
extern PayloadType payload_type_opus;
extern PayloadType payload_type_isac;
extern PayloadType payload_type_gsm_efr;
extern PayloadType payload_type_codec2;
extern PayloadType payload_type_bv16;
...
extern PayloadType payload_type_theora;
extern PayloadType payload_type_h264;
extern PayloadType payload_type_h265;
extern PayloadType payload_type_x_snow;
extern PayloadType payload_type_jpeg;
extern PayloadType payload_type_vp8;

extern PayloadType payload_type_g722;


extern PayloadType payload_type_t140;
extern PayloadType payload_type_t140_red;


extern PayloadType payload_type_x_udpftp;


extern PayloadType payload_type_telephone_event;
# 28 "/usr/include/mediastreamer2/mscommon.h" 2 3 4
# 145 "/usr/include/mediastreamer2/mscommon.h" 3 4
...
# 178 "/usr/include/mediastreamer2/mscommon.h" 3 4
 __attribute__ ((deprecated)) bctbx_list_t * ms_list_append(bctbx_list_t *list, void * data);
 ...
 __attribute__ ((deprecated)) bctbx_list_t *ms_list_append_link(bctbx_list_t *list, bctbx_list_t *new_elem);
 ...
 __attribute__ ((deprecated)) bctbx_list_t * ms_list_prepend(bctbx_list_t *list, void * data);
# 203 "/usr/include/mediastreamer2/mscommon.h" 3 4
 __attribute__ ((deprecated)) bctbx_list_t * ms_list_free(bctbx_list_t *list);
 ...
 __attribute__ ((deprecated)) bctbx_list_t * ms_list_free_with_data(bctbx_list_t *list, void (*freefunc)(void*));
 ...
 __attribute__ ((deprecated)) bctbx_list_t * ms_list_concat(bctbx_list_t *first, bctbx_list_t *second);
 ...
 __attribute__ ((deprecated)) bctbx_list_t * ms_list_remove(bctbx_list_t *list, void *data);
# 236 "/usr/include/mediastreamer2/mscommon.h" 3 4
 __attribute__ ((deprecated)) bctbx_list_t * ms_list_remove_custom(bctbx_list_t *list, MSCompareFunc compare_func, const void *user_data);
 ...
 __attribute__ ((deprecated)) int ms_list_size(const bctbx_list_t *list);
 ...
 __attribute__ ((deprecated)) void ms_list_for_each(const bctbx_list_t *list, MSIterateFunc iterate_func);
 ...
 __attribute__ ((deprecated)) void ms_list_for_each2(const bctbx_list_t *list, MSIterate2Func iterate_func, void *user_data);

 __attribute__ ((deprecated)) void ms_list_for_each3(const bctbx_list_t *list, MSIterate3Func iterate_func, void *user_data, void *factory);
 ...
 __attribute__ ((deprecated)) bctbx_list_t *ms_list_remove_link(bctbx_list_t *list, bctbx_list_t *elem);
 ...
 __attribute__ ((deprecated)) bctbx_list_t *ms_list_find(bctbx_list_t *list, void *data);
# 285 "/usr/include/mediastreamer2/mscommon.h" 3 4
 __attribute__ ((deprecated)) bctbx_list_t *ms_list_find_custom(bctbx_list_t *list, MSCompareFunc compare_func, const void *user_data);
 ...
 __attribute__ ((deprecated)) void * ms_list_nth_data(const bctbx_list_t *list, int index);
 ...
 __attribute__ ((deprecated)) int ms_list_position(const bctbx_list_t *list, bctbx_list_t *elem);
 ...
 __attribute__ ((deprecated)) int ms_list_index(const bctbx_list_t *list, void *data);
# 318 "/usr/include/mediastreamer2/mscommon.h" 3 4
 __attribute__ ((deprecated)) bctbx_list_t *ms_list_insert_sorted(bctbx_list_t *list, void *data, MSCompareFunc compare_func);
# 327 "/usr/include/mediastreamer2/mscommon.h" 3 4
 __attribute__ ((deprecated)) bctbx_list_t *ms_list_insert(bctbx_list_t *list, bctbx_list_t *before, void *data);
 ...
 __attribute__ ((deprecated)) bctbx_list_t *ms_list_copy(const bctbx_list_t *list);
 ...
 __attribute__ ((deprecated)) bctbx_list_t *ms_list_copy_with_data(const bctbx_list_t *list, void *(*copyfunc)(void *));




 __attribute__ ((deprecated)) bctbx_list_t* ms_list_next(const bctbx_list_t *list);
...
# 392 "/usr/include/mediastreamer2/mscommon.h" 3 4
 __attribute__ ((deprecated)) void ms_base_init(void);
 ...
 __attribute__ ((deprecated)) void ms_voip_init(void);
# 409 "/usr/include/mediastreamer2/mscommon.h" 3 4
 __attribute__ ((deprecated)) void ms_plugins_init(void);
 ...
 __attribute__ ((deprecated)) void ms_set_plugins_dir(const char *path);
# 430 "/usr/include/mediastreamer2/mscommon.h" 3 4
 __attribute__ ((deprecated)) int ms_load_plugins(const char *directory);
 ...
 __attribute__ ((deprecated)) void ms_base_exit(void);
 ...
 __attribute__ ((deprecated)) void ms_voip_exit(void);





 __attribute__ ((deprecated)) void ms_plugins_exit(void);
...
# 469 "/usr/include/mediastreamer2/mscommon.h" 3 4
 __attribute__ ((deprecated)) int ms_get_payload_max_size(void);





 __attribute__ ((deprecated)) void ms_set_payload_max_size(int size);
 ...
 __attribute__ ((deprecated)) void ms_set_mtu(int mtu);





 __attribute__ ((deprecated)) int ms_get_mtu(void);





 __attribute__ ((deprecated)) void ms_set_cpu_count(unsigned int c);




 __attribute__ ((deprecated)) unsigned int ms_get_cpu_count(void);
...
# 24 "/usr/include/mediastreamer2/mssndcard.h" 2 3 4
# 1 "/usr/include/mediastreamer2/msfactory.h" 1 3 4
# 24 "/usr/include/mediastreamer2/msfactory.h" 3 4
# 1 "/usr/include/mediastreamer2/msfilter.h" 1 3 4
# 24 "/usr/include/mediastreamer2/msfilter.h" 3 4
# 1 "/usr/include/mediastreamer2/msqueue.h" 1 3 4
# 26 "/usr/include/mediastreamer2/msqueue.h" 3 4
...
static inline void ms_queue_insert(MSQueue *q, mblk_t *em, mblk_t *m) {
    insq(&q->q, em, m);
    return;
}

static inline mblk_t * ms_queue_peek_last(const MSQueue *q){
 return ((&q->q)->_q_stopper.b_prev!=&(&q->q)->_q_stopper ? (&q->q)->_q_stopper.b_prev : ((void *)0));
}

static inline mblk_t *ms_queue_peek_first(const MSQueue *q){
 return ((&q->q)->_q_stopper.b_next);
}



static inline bool_t ms_queue_end(const MSQueue *q, const mblk_t *m){
 return ((m)==&(&q->q)->_q_stopper);
}
...
static inline bool_t ms_queue_empty(const MSQueue *q){
 return (&(&q->q)->_q_stopper==(&q->q)->_q_stopper.b_next);
}
# 89 "/usr/include/mediastreamer2/msqueue.h" 3 4
 void ms_queue_init(MSQueue *q);

 void ms_queue_flush(MSQueue *q);

 void ms_queue_destroy(MSQueue *q);
# 121 "/usr/include/mediastreamer2/msqueue.h" 3 4
...
static inline size_t ms_bufferizer_get_avail(MSBufferizer *obj){
 return obj->size;
}
...
typedef struct _MSFlowControlledBufferizer MSFlowControlledBufferizer;
 ...
 MSFlowControlledBufferizer * ms_flow_controlled_bufferizer_new(struct _MSFilter *f, int samplerate, int nchannels);

 void ms_flow_controlled_bufferizer_init(MSFlowControlledBufferizer *obj, struct _MSFilter *f, int samplerate, int nchannels);
...
# 25 "/usr/include/mediastreamer2/msfilter.h" 2 3 4
# 1 "/usr/include/mediastreamer2/allfilters.h" 1 3 4
# 27 "/usr/include/mediastreamer2/allfilters.h" 3 4
...
# 26 "/usr/include/mediastreamer2/msfilter.h" 2 3 4
# 1 "/usr/include/mediastreamer2/formats.h" 1 3 4
# 32 "/usr/include/mediastreamer2/formats.h" 3 4
...
typedef struct _MSFmtDescriptor MSFmtDescriptor;
 ...
 const char *ms_fmt_descriptor_to_string(const MSFmtDescriptor *orig);

 bool_t ms_fmt_descriptor_equals(const MSFmtDescriptor *fmt1, const MSFmtDescriptor *fmt2);
# 27 "/usr/include/mediastreamer2/msfilter.h" 2 3 4
# 1 "/usr/include/mediastreamer2/box-plot.h" 1 3 4
# 25 "/usr/include/mediastreamer2/box-plot.h" 3 4
...
# 28 "/usr/include/mediastreamer2/msfilter.h" 2 3 4
# 50 "/usr/include/mediastreamer2/msfilter.h" 3 4
...
# 76 "/usr/include/mediastreamer2/msfilter.h" 3 4
...
# 132 "/usr/include/mediastreamer2/msfilter.h" 3 4
...
# 248 "/usr/include/mediastreamer2/msfilter.h" 3 4
 __attribute__ ((deprecated)) void ms_filter_register(MSFilterDesc *desc);
# 260 "/usr/include/mediastreamer2/msfilter.h" 3 4
 __attribute__ ((deprecated)) MSFilterDesc * ms_filter_get_encoding_capturer(const char *mime);
# 270 "/usr/include/mediastreamer2/msfilter.h" 3 4
 __attribute__ ((deprecated)) MSFilterDesc * ms_filter_get_decoding_renderer(const char *mime);
# 281 "/usr/include/mediastreamer2/msfilter.h" 3 4
 __attribute__ ((deprecated)) MSFilterDesc * ms_filter_get_encoder(const char *mime);
# 292 "/usr/include/mediastreamer2/msfilter.h" 3 4
 __attribute__ ((deprecated)) MSFilterDesc * ms_filter_get_decoder(const char *mime);
# 304 "/usr/include/mediastreamer2/msfilter.h" 3 4
 __attribute__ ((deprecated)) MSFilterDesc *ms_filter_lookup_by_name(const char *filter_name);
# 313 "/usr/include/mediastreamer2/msfilter.h" 3 4
 __attribute__ ((deprecated)) bctbx_list_t *ms_filter_lookup_by_interface(MSFilterInterfaceId id);
# 323 "/usr/include/mediastreamer2/msfilter.h" 3 4
 __attribute__ ((deprecated)) MSFilter * ms_filter_create_encoder(const char *mime);
# 334 "/usr/include/mediastreamer2/msfilter.h" 3 4
 __attribute__ ((deprecated)) MSFilter * ms_filter_create_decoder(const char *mime);
# 344 "/usr/include/mediastreamer2/msfilter.h" 3 4
 __attribute__ ((deprecated)) bool_t ms_filter_codec_supported(const char *mime);
# 354 "/usr/include/mediastreamer2/msfilter.h" 3 4
 __attribute__ ((deprecated)) MSFilter *ms_filter_new(MSFilterId id);
# 364 "/usr/include/mediastreamer2/msfilter.h" 3 4
 __attribute__ ((deprecated)) MSFilter *ms_filter_new_from_name(const char *name);
# 377 "/usr/include/mediastreamer2/msfilter.h" 3 4
 __attribute__ ((deprecated)) MSFilter *ms_filter_new_from_desc(MSFilterDesc *desc);
# 392 "/usr/include/mediastreamer2/msfilter.h" 3 4
 int ms_filter_link(MSFilter *f1, int pin1, MSFilter *f2, int pin2);
# 404 "/usr/include/mediastreamer2/msfilter.h" 3 4
 int ms_filter_unlink(MSFilter *f1, int pin1, MSFilter *f2, int pin2);
# 415 "/usr/include/mediastreamer2/msfilter.h" 3 4
 int ms_filter_call_method(MSFilter *f, unsigned int id, void *arg);
# 425 "/usr/include/mediastreamer2/msfilter.h" 3 4
 int ms_filter_call_method_noarg(MSFilter *f, unsigned int id);
# 436 "/usr/include/mediastreamer2/msfilter.h" 3 4
 bool_t ms_filter_has_method(MSFilter *f, unsigned int id);
# 445 "/usr/include/mediastreamer2/msfilter.h" 3 4
 bool_t ms_filter_implements_interface(MSFilter *f, MSFilterInterfaceId id);
# 454 "/usr/include/mediastreamer2/msfilter.h" 3 4
 bool_t ms_filter_desc_implements_interface(MSFilterDesc *desc, MSFilterInterfaceId id);
# 469 "/usr/include/mediastreamer2/msfilter.h" 3 4
 void ms_filter_add_notify_callback(MSFilter *f, MSFilterNotifyFunc fn, void *userdata, bool_t synchronous);
# 479 "/usr/include/mediastreamer2/msfilter.h" 3 4
 void ms_filter_remove_notify_callback(MSFilter *f, MSFilterNotifyFunc fn, void *userdata);
# 488 "/usr/include/mediastreamer2/msfilter.h" 3 4
...
# 557 "/usr/include/mediastreamer2/msfilter.h" 3 4
 ...
 __attribute__ ((deprecated)) void ms_filter_enable_statistics(bool_t enabled);
 ...
 __attribute__ ((deprecated)) void ms_filter_reset_statistics(void);





 __attribute__ ((deprecated)) const bctbx_list_t * ms_filter_get_statistics(void);





 __attribute__ ((deprecated)) void ms_filter_log_statistics(void);
# 680 "/usr/include/mediastreamer2/msfilter.h" 3 4
typedef struct _MSPinFormat{
 uint16_t pin;
 const MSFmtDescriptor *fmt;
}MSPinFormat;
# 732 "/usr/include/mediastreamer2/msfilter.h" 3 4
...
# 1 "/usr/include/mediastreamer2/msinterfaces.h" 1 3 4
# 23 "/usr/include/mediastreamer2/msinterfaces.h" 3 4
# 1 "/usr/include/mediastreamer2/mscodecutils.h" 1 3 4
# 32 "/usr/include/mediastreamer2/mscodecutils.h" 3 4
typedef struct _MSConcealerContext MSConcealerContext;
 ...
 MSConcealerContext* ms_concealer_context_new(uint32_t max_plc_count);
...
# 60 "/usr/include/mediastreamer2/mscodecutils.h" 3 4
...
# 97 "/usr/include/mediastreamer2/mscodecutils.h" 3 4
...
# 130 "/usr/include/mediastreamer2/mscodecutils.h" 3 4
typedef PayloadType * (*MSPayloadMatcherFunc)(MSOfferAnswerContext *context, const bctbx_list_t *local_payloads, const PayloadType *remote_payload, const bctbx_list_t *remote_payloads, bool_t is_reading);
...
# 153 "/usr/include/mediastreamer2/mscodecutils.h" 3 4
 PayloadType * ms_offer_answer_context_match_payload(MSOfferAnswerContext *context, const bctbx_list_t *local_payloads, const PayloadType *remote_payload, const bctbx_list_t *remote_payloads, bool_t is_reading);
...
typedef struct _MSIFrameRequestsLimiterCtx {
 ...
 void ms_iframe_requests_limiter_init(MSIFrameRequestsLimiterCtx *obj, int min_iframe_interval_ms);

 void ms_iframe_requests_limiter_request_iframe(MSIFrameRequestsLimiterCtx *obj);

 bool_t ms_iframe_requests_limiter_iframe_requested(const MSIFrameRequestsLimiterCtx *obj, uint64_t curtime_ms);

 void ms_iframe_requests_limiter_notify_iframe_sent(MSIFrameRequestsLimiterCtx *obj, uint64_t curtime_ms);
...
# 24 "/usr/include/mediastreamer2/msinterfaces.h" 2 3 4
...
# 103 "/usr/include/mediastreamer2/msinterfaces.h" 3 4
enum _MSPlayerState{
 MSPlayerClosed,
 MSPlayerPaused,
 MSPlayerPlaying
...
# 148 "/usr/include/mediastreamer2/msinterfaces.h" 3 4
...
# 303 "/usr/include/mediastreamer2/msinterfaces.h" 3 4
enum _MSAudioRoute{
 MSAudioRouteEarpiece,
 MSAudioRouteSpeaker
};
typedef enum _MSAudioRoute MSAudioRoute;
# 762 "/usr/include/mediastreamer2/msfilter.h" 2 3 4
# 1 "/usr/include/mediastreamer2/msfactory.h" 1 3 4
# 763 "/usr/include/mediastreamer2/msfilter.h" 2 3 4
# 25 "/usr/include/mediastreamer2/msfactory.h" 2 3 4
# 1 "/usr/include/mediastreamer2/devices.h" 1 3 4
# 40 "/usr/include/mediastreamer2/devices.h" 3 4
...
struct MSDevicesInfo {
 bctbx_list_t *sound_devices_descriptions;
};
...
# 26 "/usr/include/mediastreamer2/msfactory.h" 2 3 4


struct _MSFactory{
 bctbx_list_t *desc_list;
 bctbx_list_t *stats_list;
 bctbx_list_t *offer_answer_provider_list;



 bctbx_list_t *formats;
...
# 71 "/usr/include/mediastreamer2/msfactory.h" 3 4
...
__attribute__ ((deprecated)) MSFactory *ms_factory_create_fallback(void);





__attribute__ ((deprecated)) MSFactory *ms_factory_get_fallback(void);
 ...
 struct _MSSndCardManager* ms_factory_get_snd_card_manager(MSFactory *f);
...
# 172 "/usr/include/mediastreamer2/msfactory.h" 3 4
 ...
 const bctbx_list_t *ms_factory_get_filter_decs(const MSFactory *factory);
# 195 "/usr/include/mediastreamer2/msfactory.h" 3 4
 MSFilter * ms_factory_create_encoder(MSFactory *factory, const char *mime);
# 204 "/usr/include/mediastreamer2/msfactory.h" 3 4
 MSFilter * ms_factory_create_decoder(MSFactory *factory, const char *mime);
# 213 "/usr/include/mediastreamer2/msfactory.h" 3 4
 bool_t ms_factory_codec_supported(MSFactory *factory, const char *mime);
# 222 "/usr/include/mediastreamer2/msfactory.h" 3 4
 bool_t ms_factory_has_encoder(MSFactory *factory, const char *mime);
# 231 "/usr/include/mediastreamer2/msfactory.h" 3 4
 bool_t ms_factory_has_decoder(MSFactory *factory, const char *mime);
# 241 "/usr/include/mediastreamer2/msfactory.h" 3 4
 MSFilter *ms_factory_create_filter(MSFactory *factory, MSFilterId id);
# 250 "/usr/include/mediastreamer2/msfactory.h" 3 4
 MSFilter *ms_factory_create_filter_from_name(MSFactory *factory, const char *name);
# 262 "/usr/include/mediastreamer2/msfactory.h" 3 4
 ...
 void ms_factory_uninit_plugins(MSFactory *obj);
 ...
 void ms_factory_set_event_queue(MSFactory *obj,struct _MSEventQueue *q);
 ...
 const struct _MSFmtDescriptor * ms_factory_get_audio_format(MSFactory *obj, const char *mime, int rate, int channels, const char *fmtp);

 const struct _MSFmtDescriptor * ms_factory_get_video_format(MSFactory *obj, const char *mime, MSVideoSize size, float fps, const char *fmtp);

 const MSFmtDescriptor *ms_factory_get_format(MSFactory *obj, const MSFmtDescriptor *ref);
# 386 "/usr/include/mediastreamer2/msfactory.h" 3 4
 int ms_factory_enable_filter_from_name(MSFactory *factory, const char *name, bool_t enable);
# 396 "/usr/include/mediastreamer2/msfactory.h" 3 4
...
# 415 "/usr/include/mediastreamer2/msfactory.h" 3 4
...
# 25 "/usr/include/mediastreamer2/mssndcard.h" 2 3 4
# 39 "/usr/include/mediastreamer2/mssndcard.h" 3 4
...
# 184 "/usr/include/mediastreamer2/mssndcard.h" 3 4
 __attribute__ ((deprecated)) MSSndCardManager * ms_snd_card_manager_get(void);
...
# 313 "/usr/include/mediastreamer2/mssndcard.h" 3 4
...
# 339 "/usr/include/mediastreamer2/mssndcard.h" 3 4
 struct _MSFilter * ms_snd_card_create_reader(MSSndCard *obj);
# 348 "/usr/include/mediastreamer2/mssndcard.h" 3 4
 struct _MSFilter * ms_snd_card_create_writer(MSSndCard *obj);
# 357 "/usr/include/mediastreamer2/mssndcard.h" 3 4
 MSSndCard * ms_snd_card_new(MSSndCardDesc *desc);
# 368 "/usr/include/mediastreamer2/mssndcard.h" 3 4
...
# 560 "/usr/include/mediastreamer2/mssndcard.h" 3 4
...
# 578 "/usr/include/mediastreamer2/mssndcard.h" 3 4
...
# 597 "/usr/include/mediastreamer2/mssndcard.h" 3 4
...
# 6 "lua_filter_demo.c" 2
# 1 "/usr/include/mediastreamer2/dtmfgen.h" 1 3 4
# 39 "/usr/include/mediastreamer2/dtmfgen.h" 3 4
...
# 60 "/usr/include/mediastreamer2/dtmfgen.h" 3 4
...
# 7 "lua_filter_demo.c" 2
# 1 "/usr/include/mediastreamer2/msfilerec.h" 1 3 4
# 24 "/usr/include/mediastreamer2/msfilerec.h" 3 4
extern MSFilterDesc ms_file_rec_desc;
# 8 "lua_filter_demo.c" 2


# 1 "/usr/include/mediastreamer2/msticker.h" 1 3 4
# 45 "/usr/include/mediastreamer2/msticker.h" 3 4
...
struct _MSTicker
{
 ortp_mutex_t lock;
 ortp_cond_t cond;
 bctbx_list_t *execution_list;
 bctbx_list_t *task_list;
...
# 140 "/usr/include/mediastreamer2/msticker.h" 3 4
...
# 170 "/usr/include/mediastreamer2/msticker.h" 3 4
 int ms_ticker_attach(MSTicker *ticker,MSFilter *f);
# 183 "/usr/include/mediastreamer2/msticker.h" 3 4
 int ms_ticker_attach_multiple(MSTicker *ticker,MSFilter *f,...);
# 195 "/usr/include/mediastreamer2/msticker.h" 3 4
...
# 215 "/usr/include/mediastreamer2/msticker.h" 3 4
 void ms_ticker_set_time_func(MSTicker *ticker, MSTickerTimeFunc func, void *user_data);
# 226 "/usr/include/mediastreamer2/msticker.h" 3 4
...
# 242 "/usr/include/mediastreamer2/msticker.h" 3 4
...
# 1 "/usr/include/lua5.3/lua.h" 1 3 4
# 12 "/usr/include/lua5.3/lua.h" 3 4
# 1 "/usr/lib/gcc/x86_64-linux-gnu/11/include/stddef.h" 1 3 4
...
# 13 "/usr/include/lua5.3/lua.h" 2 3 4


# 1 "/usr/include/lua5.3/luaconf.h" 1 3 4
# 11 "/usr/include/lua5.3/luaconf.h" 3 4
...
# 12 "/usr/include/lua5.3/luaconf.h" 2 3 4
# 1 "/usr/lib/gcc/x86_64-linux-gnu/11/include/stddef.h" 1 3 4
# 13 "/usr/include/lua5.3/luaconf.h" 2 3 4
# 204 "/usr/include/lua5.3/luaconf.h" 3 4
# 1 "/usr/include/x86_64-linux-gnu/lua5.3-deb-multiarch.h" 1 3 4
# 205 "/usr/include/lua5.3/luaconf.h" 2 3 4
# 16 "/usr/include/lua5.3/lua.h" 2 3 4
# 55 "/usr/include/lua5.3/lua.h" 3 4
typedef struct lua_State lua_State;
# 88 "/usr/include/lua5.3/lua.h" 3 4
...
# 138 "/usr/include/lua5.3/lua.h" 3 4
...
# 210 "/usr/include/lua5.3/lua.h" 3 4
...
# 311 "/usr/include/lua5.3/lua.h" 3 4
...
# 416 "/usr/include/lua5.3/lua.h" 3 4
...
# 9 "lua_filter.h" 2
# 1 "/usr/include/lua5.3/lauxlib.h" 1 3 4
# 12 "/usr/include/lua5.3/lauxlib.h" 3 4
# 1 "/usr/lib/gcc/x86_64-linux-gnu/11/include/stddef.h" 1 3 4
# 13 "/usr/include/lua5.3/lauxlib.h" 2 3 4


# 1 "/usr/include/lua5.3/lua.h" 1 3 4
# 16 "/usr/include/lua5.3/lauxlib.h" 2 3 4
# 31 "/usr/include/lua5.3/lauxlib.h" 3 4
...
# 148 "/usr/include/lua5.3/lauxlib.h" 3 4
...
# 163 "/usr/include/lua5.3/lauxlib.h" 3 4
...
# 193 "/usr/include/lua5.3/lauxlib.h" 3 4
typedef struct luaL_Stream {
  FILE *f;
  lua_CFunction closef;
} luaL_Stream;
# 10 "lua_filter.h" 2
# 1 "/usr/include/lua5.3/lualib.h" 1 3 4
# 18 "/usr/include/lua5.3/lualib.h" 3 4
...
struct _app_vars
{
 ...
 MSSndCardManager *scm;
    char cards_count;
 const char **cards;
    char* script_preambula_name;
    char* script_body_name;
};
...
# 67 "lua_filter_demo.c" 3 4
                                      ortp_strdup
# 67 "lua_filter_demo.c"
                                               (argv[i+1]);
        ...
        {
            v->script_body_name = 
# 73 "lua_filter_demo.c" 3 4
                                 ortp_strdup
# 73 "lua_filter_demo.c"
                                          (argv[i+1]);
        ...
        {
            v -> en_gen = 
# 79 "lua_filter_demo.c" 3 4
                         1
# 79 "lua_filter_demo.c"
                             ;
        ...
        {
            v -> en_rec = 
# 87 "lua_filter_demo.c" 3 4
                         1
# 87 "lua_filter_demo.c"
                             ;
...
char* get_file(char *filename) {
    ...
    if (stat(filename, &file_status) < 0) {
        return 
# 98 "lua_filter_demo.c" 3 4
              ((void *)0)
# 98 "lua_filter_demo.c"
                  ;
    }
    char* res = 
# 100 "lua_filter_demo.c" 3 4
               ((void *)0)
# 100 "lua_filter_demo.c"
                   ;
    const size_t file_size = file_status.st_size;
    char* buf = 
# 102 "lua_filter_demo.c" 3 4
                ortp_malloc0
# 102 "lua_filter_demo.c"
                          (file_size + 1);
...
# 125 "lua_filter_demo.c" 3 4
                                     (unsigned int)(((((unsigned int)(
# 125 "lua_filter_demo.c"
                                     4001
# 125 "lua_filter_demo.c" 3 4
...
static void load_script_preambula(app_vars *v, MSFilter* filter)
{
    ...
    {
        ms_filter_call_method(filter, 
# 143 "lua_filter_demo.c" 3 4
                                     (unsigned int)(((((unsigned int)(
# 143 "lua_filter_demo.c"
                                     4001
# 143 "lua_filter_demo.c" 3 4
                                     )) & 0xFFFF)<<16) | (((unsigned int)(
# 143 "lua_filter_demo.c"
...
static void build_sound_cards_table(app_vars *v)
{
 ...
 v -> cards = 
# 161 "lua_filter_demo.c" 3 4
             ortp_malloc
# 161 "lua_filter_demo.c"
                      ((ndev + 1)*sizeof(const char *));
 for ( i = 0; elem != 
# 162 "lua_filter_demo.c" 3 4
                     ((void *)0)
# 162 "lua_filter_demo.c"
                         ; elem = elem->next, i++)
 {
  v -> cards[i] = ms_snd_card_get_string_id((MSSndCard *)elem -> data);
 }
 v -> cards[ndev] = 
# 166 "lua_filter_demo.c" 3 4
                   ((void *)0)
# 166 "lua_filter_demo.c"
                       ;
 v -> cards_count = ndev;
}
...
int main(int argc, char *argv[])
{
 ...
 ms_factory_init_voip(vars.mf);
    ...
    MSSndCard *snd_card =
 ms_snd_card_manager_get_card(vars.scm, vars.cards[0]);
 ...
 ms_factory_register_filter(vars.mf, &lua_filter_desc);
    ...
    MSFilter *lua_filter = ms_factory_create_filter(vars.mf, 4001);
...
# 248 "lua_filter_demo.c" 3 4
                                       (unsigned int)(((((unsigned int)(MS_FILE_REC_ID)) & 0xFFFF)<<16) | (((unsigned int)(0))<<8) | (((unsigned int)sizeof(const char)) & 0xFF))
# 248 "lua_filter_demo.c"
                                                       , recording_name );
        ms_filter_call_method(recorder, 
# 249 "lua_filter_demo.c" 3 4
                                       (unsigned int)(((((unsigned int)(MS_FILE_REC_ID)) & 0xFFFF)<<16) | (((unsigned int)(1))<<8) | (((unsigned int)0) & 0xFF))
# 249 "lua_filter_demo.c"
                                                        , 0);
    }
