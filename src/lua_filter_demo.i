...
# 66 "lua_filter_demo.c" 3 4
                                      ortp_strdup
# 66 "lua_filter_demo.c"
                                               (argv[i+1]);
        ...
        {
            v->script_body_name = 
# 72 "lua_filter_demo.c" 3 4
                                 ortp_strdup
# 72 "lua_filter_demo.c"
                                          (argv[i+1]);
        ...
        {
            v -> en_gen = 
# 78 "lua_filter_demo.c" 3 4
                         1
# 78 "lua_filter_demo.c"
                             ;
        ...
        {
            v -> en_rec = 
# 86 "lua_filter_demo.c" 3 4
                         1
# 86 "lua_filter_demo.c"
                             ;
...
static void load_script_body(app_vars *v, MSFilter* filter)
{
    ...
    char buf[1024 + 1];
    memset(buf, 0, 1024 + 1);
    size_t read_res = fread(buf, 1, 1024, f);
    fclose(f);
    if ((read_res > 0) && (read_res <= 1024))
    {
        printf("Script's body <%s>: <\n%s\n> will be loaded to lua-filter.\n",
                  v->script_body_name, buf);
        char* cpy = 
# 106 "lua_filter_demo.c" 3 4
                   ortp_strdup 
# 106 "lua_filter_demo.c"
                             (buf);
        ms_filter_call_method(filter, 
# 107 "lua_filter_demo.c" 3 4
                                     (unsigned int)(((((unsigned int)(
# 107 "lua_filter_demo.c"
                                     4001
# 107 "lua_filter_demo.c" 3 4
